...
msbuild /p:Platform=%BUILD_PLATFORM% /p:Configuration=Release /p:PlatformToolset=%PLATFORM_TOOLSET% /p:WarningLevel=TurnOffAllWarnings src\FreeImage\FreeImage.2013.vcxproj || exit /b 1
